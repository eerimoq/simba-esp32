 ...
 * @return esp_err_t
 */
esp_err_t esp_spi_flash_write(size_t dest, const void *src, size_t size);
 ...
 * @return esp_err_t
 */
esp_err_t esp_spi_flash_write_encrypted(size_t dest, const void *src, size_t size);
 ...
 * @return esp_err_t
 */
esp_err_t esp_spi_flash_read(size_t src, void *dest, size_t size);
 ...
 */
esp_err_t esp_spi_flash_mmap(uint32_t src_addr, size_t size, spi_flash_mmap_memory_t memory,
