 ...
 */
SSL_CTX* esp_SSL_CTX_new(const SSL_METHOD *method);
 ...
 * @return none
 */
void esp_SSL_CTX_free(SSL_CTX *ctx);
 ...
 *     < 0 : an esp_error catch
 */
int esp_SSL_read(SSL *ssl, void *buffer, int len);
 ...
 *     < 0 : an esp_error catch
 */
int esp_SSL_write(SSL *ssl, const void *buffer, int len);
 ...
 *    -1 : an esp_error catch
 */
int esp_SSL_shutdown(SSL *ssl);
 ...
 *     0 : failed
 */
int esp_SSL_set_fd(SSL *ssl, int fd);
 ...
 *     0 : failed
 */
int esp_SSL_CTX_use_PrivateKey(SSL_CTX *ctx, EVP_PKEY *pkey);
 ...
 *     0 : failed
 */
int esp_SSL_CTX_use_certificate(SSL_CTX *ctx, X509 *x);
 ...
 */
const SSL_METHOD* esp_TLSv1_client_method(void);
 ...
 */
const SSL_METHOD* esp_SSLv3_client_method(void);
 ...
 */
const SSL_METHOD* esp_TLSv1_1_client_method(void);
 ...
 */
const SSL_METHOD* esp_TLSv1_2_client_method(void);
 ...
 */
const SSL_METHOD* esp_TLS_client_method(void);
 ...
 */
const SSL_METHOD* esp_TLSv1_1_server_method(void);
 ...
 */
const SSL_METHOD* esp_TLSv1_2_server_method(void);
 ...
 */
const SSL_METHOD* esp_TLSv1_server_method(void);
 ...
 */
const SSL_METHOD* esp_SSLv3_server_method(void);
 ...
 */
const SSL_METHOD* esp_TLS_server_method(void);
...
/**
 * @brief get SSL esp_error code
 *
 * @param ssl       - SSL point
 * @param ret_code  - SSL return code
 *
 * @return SSL esp_error number
 */
int esp_SSL_get_error(const SSL *ssl, int ret_code);

/**
 * @brief clear the SSL esp_error code
 *
 * @param none
 *
 * @return none
...
/**
 * @brief get the current SSL esp_error code
 *
 * @param none
 *
 * @return current SSL esp_error number
 */
int ERR_get_error(void);

/**
 * @brief register the SSL esp_error strings
 *
 * @param none
 *
 * @return none
...
/**
 * @brief generates a human-readable string representing the esp_error code e
 *        and store it into the "ret" point memory
 *
 * @param e   - esp_error code
 ...
 */
unsigned long esp_SSL_CTX_set_options(SSL_CTX *ctx, unsigned long opt);
 ...
 *    -1 : a esp_error catch
 */
int esp_SSL_do_handshake(SSL *ssl);
 ...
 */
const char *esp_SSL_get_version(const SSL *ssl);
 ...
 *     0 : failed
 */
int esp_SSL_CTX_set_ssl_version(SSL_CTX *ctx, const SSL_METHOD *meth);
 ...
 * @return bytes number
 */
int esp_SSL_pending(const SSL *ssl);
 ...
 *     1 : true
 */
int esp_SSL_want_nothing(const SSL *ssl);
 ...
 *     1 : true
 */
int esp_SSL_want_read(const SSL *ssl);
 ...
 *     1 : true
 */
int esp_SSL_want_write(const SSL *ssl);
 ...
 */
const SSL_METHOD *esp_SSL_CTX_get_ssl_method(SSL_CTX *ctx);
 ...
 */
const SSL_METHOD *esp_SSL_get_ssl_method(SSL *ssl);
 ...
 *     0 : failed
 */
int esp_SSL_set_ssl_method(SSL *ssl, const SSL_METHOD *method);
 ...
 *     0 : failed
 */
int esp_SSL_add_client_CA(SSL *ssl, X509 *x);
 ...
 *     0 : failed
 */
int esp_SSL_CTX_add_client_CA(SSL_CTX *ctx, X509 *x);
 ...
 */
X509 *esp_SSL_get_certificate(const SSL *ssl);
 ...
 * @return none
 */
void esp_SSL_set_info_callback(SSL *ssl, void (*cb) (const SSL *ssl, int type, int val));
 ...
 * @return SSL state
 */
OSSL_HANDSHAKE_STATE esp_SSL_get_state(const SSL *ssl);
 ...
 * @return none
 */
void esp_SSL_CTX_set_default_read_buffer_len(SSL_CTX *ctx, size_t len);
 ...
 * @return none
 */
void esp_SSL_set_default_read_buffer_len(SSL *ssl, size_t len);
 ...
 * @return none
 */
void esp_SSL_set_security_level(SSL *ssl, int level);
 ...
 */
int esp_SSL_get_security_level(const SSL *ssl);
 ...
 */
int esp_SSL_CTX_get_verify_mode(const SSL_CTX *ctx);
 ...
 */
int esp_SSL_CTX_get_verify_depth(const SSL_CTX *ctx);
 ...
 * @return none
 */
void esp_SSL_CTX_set_verify(SSL_CTX *ctx, int mode, int (*verify_callback)(int, X509_STORE_CTX *));
 ...
 * @return none
 */
void esp_SSL_set_verify(SSL *s, int mode, int (*verify_callback)(int, X509_STORE_CTX *));
 ...
 */
long esp_SSL_CTX_set_timeout(SSL_CTX *ctx, long t);
 ...
 */
long esp_SSL_CTX_get_timeout(const SSL_CTX *ctx);
 ...
 */
int esp_SSL_want(const SSL *ssl);
 ...
 *     0 : failed
 */
int esp_SSL_want_x509_lookup(const SSL *ssl);
 ...
 *      < 0 : a esp_error catch
 */
int esp_SSL_get_fd(const SSL *ssl);
 ...
 *      < 0 : a esp_error catch
 */
int esp_SSL_get_rfd(const SSL *ssl);
 ...
 *      < 0 : a esp_error catch
 */
int esp_SSL_get_wfd(const SSL *ssl);
 ...
 * @return none
 */
void esp_SSL_set_read_ahead(SSL *s, int yes);
 ...
 * @return none
 */
void esp_SSL_CTX_set_read_ahead(SSL_CTX *ctx, int yes);
 ...
 */
int esp_SSL_get_read_ahead(const SSL *ssl);
 ...
 * @return SSL context ahead signal
 */
long esp_SSL_CTX_get_read_ahead(SSL_CTX *ctx);
 ...
 *         0 : no data
 */
int esp_SSL_has_pending(const SSL *ssl);
 ...
 *     0 : failed
 */
int esp_SSL_CTX_use_certificate(SSL_CTX *ctx, X509 *x);//loads the certificate x into ctx
 ...
 *     0 : failed
 */
int esp_SSL_CTX_use_certificate_ASN1(SSL_CTX *ctx, int len, const unsigned char *d);
 ...
 *     0 : failed
 */
int esp_SSL_CTX_use_certificate_file(SSL_CTX *ctx, const char *file, int type);
 ...
 *     0 : failed
 */
int esp_SSL_CTX_use_PrivateKey_ASN1(int pk, SSL_CTX *ctx, const unsigned char *d,  long len);//adds the private key of type pk stored at memory location d (length len) to ctx
 ...
 *     0 : failed
 */
int esp_SSL_CTX_use_PrivateKey_file(SSL_CTX *ctx, const char *file, int type);
 ...
 *     0 : failed
 */
int esp_SSL_CTX_use_RSAPrivateKey_ASN1(SSL_CTX *ctx, const unsigned char *d, long len);
 ...
 *     0 : failed
 */
long esp_SSL_CTX_get_default_read_ahead(SSL_CTX *ctx);
 ...
 *     0 : failed
 */
int esp_SSL_CTX_up_ref(SSL_CTX *ctx);
 ...
 */
unsigned long esp_SSL_CTX_clear_options(SSL_CTX *ctx, unsigned long op);
 ...
 * @return SSL context option
 */
unsigned long esp_SSL_CTX_get_options(SSL_CTX *ctx);
 ...
 */
const char *esp_SSL_alert_desc_string(int value);
 ...
 */
const char *esp_SSL_alert_desc_string_long(int value);
 ...
 */
const char *esp_SSL_alert_type_string(int value);
 ...
 */
const char *esp_SSL_alert_type_string_long(int value);
 ...
 * @return SSL context
 */
SSL_CTX *esp_SSL_get_SSL_CTX(const SSL *ssl);
 ...
 */
X509 *esp_SSL_get_peer_certificate(const SSL *ssl);
 ...
 */
int esp_SSL_get_shutdown(const SSL *ssl);
 ...
 * @return state string
 */
const char *esp_SSL_rstate_string(SSL *ssl);
 ...
 */
const char *esp_SSL_rstate_string_long(SSL *ssl);
 ...
 * @return SSL option
 */
unsigned long esp_SSL_clear_options(SSL *ssl, unsigned long op);
 ...
 * @return SSL option
 */
unsigned long esp_SSL_get_options(SSL *ssl);
 ...
 * @return SSL option
 */
unsigned long esp_SSL_set_options(SSL *ssl, unsigned long op);
 ...
 * @return none
 */
void esp_SSL_set_shutdown(SSL *ssl, int mode);
 ...
 * @return session time
 */
void esp_SSL_set_time(SSL *ssl, long t);
 ...
 * @return session timeout time
 */
void esp_SSL_set_timeout(SSL *ssl, long t);
 ...
 */
char *esp_SSL_state_string(const SSL *ssl);
 ...
 */
char *esp_SSL_state_string_long(const SSL *ssl);
 ...
 * @return SSL version
 */
int esp_SSL_version(const SSL *ssl);
