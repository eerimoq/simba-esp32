...
#define SKM_DEFINE_STACK_OF(t1, t2, t3) \
    ...
    { \
        return (STACK_OF(t1) *)esp_OPENSSL_sk_new_null(); \
    } \
 ...
 */
OPENSSL_STACK* esp_OPENSSL_sk_new(OPENSSL_sk_compfunc c);
 ...
 * @return openssl stack object point
 */
OPENSSL_STACK *esp_OPENSSL_sk_new_null(void);
 ...
 * @return none
 */
void esp_OPENSSL_sk_free(OPENSSL_STACK *stack);
