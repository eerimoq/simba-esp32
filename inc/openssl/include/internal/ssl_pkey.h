 ...
 */
EVP_PKEY* esp_EVP_PKEY_new(void);
 ...
 * @return private key object point
 */
EVP_PKEY* esp_d2i_PrivateKey(int type,
                         EVP_PKEY **a,
 ...
 * @return none
 */
void esp_EVP_PKEY_free(EVP_PKEY *x);
 ...
 *     1 : OK 
 */
 int esp_SSL_use_PrivateKey_ASN1(int type, SSL *ssl, const unsigned char *d, long len);
