...
#define SSL_DEBUG_OFF (SSL_DEBUG_LEVEL - 1)
        ...
        #esp_error "SSL_DEBUG_LOG is not defined"
    #endif
 ...
 *
 * if select "CONFIG_OPENSSL_ASSERT_DEBUG", SSL_ASSERT* will show esp_error file name and line
 * if select "CONFIG_OPENSSL_ASSERT_EXIT", SSL_ASSERT* will just return esp_error code.
 * if select "CONFIG_OPENSSL_ASSERT_DEBUG_EXIT" SSL_ASSERT* will show esp_error file name and line,
 * then return esp_error code.
 * if select "CONFIG_OPENSSL_ASSERT_DEBUG_BLOCK", SSL_ASSERT* will show esp_error file name and line,
