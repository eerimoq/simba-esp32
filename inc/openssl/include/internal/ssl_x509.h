 ...
 * @return X509 certification object point
 */
X509* esp_d2i_X509(X509 **cert, const unsigned char *buffer, long len);
 ...
 *
 */
int esp_SSL_use_certificate_ASN1(SSL *ssl, int len, const unsigned char *d);
