...
void *esp_ssl_mem_zalloc(size_t size);
void *esp_ssl_mem_malloc(size_t size);
void esp_ssl_mem_free(void *p);

void* esp_ssl_memcpy(void *to, const void *from, size_t size);
size_t esp_ssl_strlen(const char *src);

void esp_ssl_speed_up_enter(void);
void esp_ssl_speed_up_exit(void);
