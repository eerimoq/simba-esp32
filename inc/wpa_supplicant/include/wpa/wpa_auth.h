...
struct wpa_authenticator * esp_wpa_init(const u8 *addr,
...
int esp_wpa_validate_wpa_ie(struct wpa_authenticator *wpa_auth,
			struct wpa_state_machine *sm,
			const u8 *wpa_ie, size_t wpa_ie_len/*,
			const u8 *mdie, size_t mdie_len*/);
int esp_wpa_auth_uses_mfp(struct wpa_state_machine *sm);
struct wpa_state_machine *
esp_wpa_auth_sta_init(struct wpa_authenticator *wpa_auth, const u8 *addr);
int esp_wpa_auth_sta_associated(struct wpa_authenticator *wpa_auth,
			    struct wpa_state_machine *sm);
void esp_wpa_auth_sta_no_wpa(struct wpa_state_machine *sm);
void esp_wpa_auth_sta_deinit(struct wpa_state_machine *sm);
void esp_wpa_receive(struct wpa_authenticator *wpa_auth,
		 struct wpa_state_machine *sm,
...
void esp_wpa_remove_ptk(struct wpa_state_machine *sm);
int esp_wpa_auth_sm_event(struct wpa_state_machine *sm, wpa_event event);
