...
#define disk_initialize     esp_ff_disk_initialize
#define disk_status         esp_ff_disk_status
#define disk_read           esp_ff_disk_read
#define disk_write          esp_ff_disk_write
#define disk_ioctl          esp_ff_disk_ioctl
 ...
 */
void esp_ff_diskio_register(BYTE pdrv, const ff_diskio_impl_t* discio_impl);

#define ff_diskio_unregister(pdrv_) esp_ff_diskio_register(pdrv_, NULL)

/**
 * Register SD/MMC diskio driver
 *
 * @param pdrv  drive number
 * @param card  pointer to sdmmc_card_t structure describing a card; card should be initialized before calling esp_f_mount.
 */
void esp_ff_diskio_register_sdmmc(BYTE pdrv, sdmmc_card_t* card);
 ...
 */
esp_err_t esp_ff_diskio_get_drive(BYTE* out_pdrv);
