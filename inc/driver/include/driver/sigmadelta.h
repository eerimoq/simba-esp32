 ...
 */
esp_err_t esp_sigmadelta_config(sigmadelta_config_t *config);
 ...
 *     - ESP_ERR_INVALID_ARG Parameter esp_error
 */
esp_err_t esp_sigmadelta_set_duty(sigmadelta_channel_t channel, int8_t duty);
 ...
 *     - ESP_ERR_INVALID_ARG Parameter esp_error
 */
esp_err_t esp_sigmadelta_set_prescale(sigmadelta_channel_t channel, uint8_t prescale);
 ...
 *     - ESP_ERR_INVALID_ARG Parameter esp_error
 */
esp_err_t esp_sigmadelta_set_pin(sigmadelta_channel_t channel, gpio_num_t gpio_num);
