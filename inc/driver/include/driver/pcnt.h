 ...
 */
esp_err_t esp_pcnt_unit_config(pcnt_config_t *pcnt_config);
 ...
 *     - ESP_ERR_INVALID_ARG Parameter esp_error
 */
esp_err_t esp_pcnt_get_counter_value(pcnt_unit_t pcnt_unit, int16_t* count);
 ...
 *     - ESP_ERR_INVALID_ARG Parameter esp_error
 */
esp_err_t esp_pcnt_counter_pause(pcnt_unit_t pcnt_unit);
 ...
 *     - ESP_ERR_INVALID_ARG Parameter esp_error
 */
esp_err_t esp_pcnt_counter_resume(pcnt_unit_t pcnt_unit);
 ...
 *     - ESP_ERR_INVALID_ARG Parameter esp_error
 */
esp_err_t esp_pcnt_counter_clear(pcnt_unit_t pcnt_unit);

/**
 * @brief Enable PCNT interrupt for PCNT unit
 *        @note
 *        Each Pulse counter unit has five watch point events that share the same interrupt.
 *        Configure events with esp_pcnt_event_enable() and esp_pcnt_event_disable()
 *
 * @param pcnt_unit PCNT unit number
 *
 * @return
 ...
 *     - ESP_ERR_INVALID_ARG Parameter esp_error
 */
esp_err_t esp_pcnt_intr_enable(pcnt_unit_t pcnt_unit);
 ...
 *     - ESP_ERR_INVALID_ARG Parameter esp_error
 */
esp_err_t esp_pcnt_intr_disable(pcnt_unit_t pcnt_unit);
 ...
 *     - ESP_ERR_INVALID_ARG Parameter esp_error
 */
esp_err_t esp_pcnt_event_enable(pcnt_unit_t unit, pcnt_evt_type_t evt_type);
 ...
 *     - ESP_ERR_INVALID_ARG Parameter esp_error
 */
esp_err_t esp_pcnt_event_disable(pcnt_unit_t unit, pcnt_evt_type_t evt_type);
 ...
 *     - ESP_ERR_INVALID_ARG Parameter esp_error
 */
esp_err_t esp_pcnt_set_event_value(pcnt_unit_t unit, pcnt_evt_type_t evt_type, int16_t value);
 ...
 *     - ESP_ERR_INVALID_ARG Parameter esp_error
 */
esp_err_t esp_pcnt_get_event_value(pcnt_unit_t unit, pcnt_evt_type_t evt_type, int16_t *value);
 ...
 */
esp_err_t esp_pcnt_isr_register(void (*fn)(void*), void * arg, int intr_alloc_flags, pcnt_isr_handle_t *handle);
 ...
 *     - ESP_ERR_INVALID_ARG Parameter esp_error
 */
esp_err_t esp_pcnt_set_pin(pcnt_unit_t unit, pcnt_channel_t channel, int pulse_io, int ctrl_io);
 ...
 *     - ESP_ERR_INVALID_ARG Parameter esp_error
 */
esp_err_t esp_pcnt_filter_enable(pcnt_unit_t unit);
 ...
 *     - ESP_ERR_INVALID_ARG Parameter esp_error
 */
esp_err_t esp_pcnt_filter_disable(pcnt_unit_t unit);
 ...
 *     - ESP_ERR_INVALID_ARG Parameter esp_error
 */
esp_err_t esp_pcnt_set_filter_value(pcnt_unit_t unit, uint16_t filter_val);
 ...
 *     - ESP_ERR_INVALID_ARG Parameter esp_error
 */
esp_err_t esp_pcnt_get_filter_value(pcnt_unit_t unit, uint16_t *filter_val);
 ...
 *     - ESP_ERR_INVALID_ARG Parameter esp_error
 */
esp_err_t esp_pcnt_set_mode(pcnt_unit_t unit, pcnt_channel_t channel,
 ...
 *     .counter_l_lim = -10,
 * };
 * esp_pcnt_unit_config(&pcnt_config);        //init unit
 * @endcode
 *
 ...
 * esp_pcnt_set_event_value(PCNT_UNIT_0, PCNT_EVT_THRES_1, 5);   //set thres1 value
 * esp_pcnt_event_enable(PCNT_UNIT_0, PCNT_EVT_THRES_1);         //enable thres1 event
 * @endcode
 *
