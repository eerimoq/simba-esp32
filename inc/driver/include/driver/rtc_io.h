 ...
 */
esp_err_t esp_rtc_gpio_init(gpio_num_t gpio_num);
 ...
 *     - ESP_ERR_INVALID_ARG GPIO is not an RTC IO
 */
esp_err_t esp_rtc_gpio_deinit(gpio_num_t gpio_num);
 ...
 *     - ESP_ERR_INVALID_ARG GPIO is not an RTC IO
 */
uint32_t esp_rtc_gpio_get_level(gpio_num_t gpio_num);
 ...
 *     - ESP_ERR_INVALID_ARG GPIO is not an RTC IO
 */
esp_err_t esp_rtc_gpio_set_level(gpio_num_t gpio_num, uint32_t level);
 ...
 *     - ESP_ERR_INVALID_ARG GPIO is not an RTC IO
 */
esp_err_t esp_rtc_gpio_set_direction(gpio_num_t gpio_num, rtc_gpio_mode_t mode);

/**
 * @brief  RTC GPIO pullup enable
 *
 * This function only works for RTC IOs. In general, call esp_gpio_pullup_en,
 ...
 *     - ESP_ERR_INVALID_ARG GPIO is not an RTC IO
 */
esp_err_t esp_rtc_gpio_pullup_en(gpio_num_t gpio_num);

/**
 * @brief  RTC GPIO pulldown enable
 *
 * This function only works for RTC IOs. In general, call esp_gpio_pulldown_en,
 * which will work both for normal GPIOs and RTC IOs.
 *
 * @param  gpio_num GPIO number (e.g. GPIO_NUM_12)
 *
 ...
 *     - ESP_ERR_INVALID_ARG GPIO is not an RTC IO
 */
esp_err_t esp_rtc_gpio_pulldown_en(gpio_num_t gpio_num);

/**
 * @brief  RTC GPIO pullup disable
 *
 * This function only works for RTC IOs. In general, call esp_gpio_pullup_dis,
 * which will work both for normal GPIOs and RTC IOs.
 *
 * @param  gpio_num GPIO number (e.g. GPIO_NUM_12)
 *
 ...
 *     - ESP_ERR_INVALID_ARG GPIO is not an RTC IO
 */
esp_err_t esp_rtc_gpio_pullup_dis(gpio_num_t gpio_num);

/**
 * @brief  RTC GPIO pulldown disable
 *
 * This function only works for RTC IOs. In general, call esp_gpio_pulldown_dis,
 * which will work both for normal GPIOs and RTC IOs.
 *
 * @param  gpio_num GPIO number (e.g. GPIO_NUM_12)
 *
 ...
 *     - ESP_ERR_INVALID_ARG GPIO is not an RTC IO
 */
esp_err_t esp_rtc_gpio_pulldown_dis(gpio_num_t gpio_num);
