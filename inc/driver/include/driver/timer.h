 ...
 */
esp_err_t esp_timer_get_counter_value(timer_group_t group_num, timer_idx_t timer_num, uint64_t* timer_val);
 ...
 *     - ESP_ERR_INVALID_ARG Parameter esp_error
 */
esp_err_t esp_timer_get_counter_time_sec(timer_group_t group_num, timer_idx_t timer_num, double* time);
 ...
 *     - ESP_ERR_INVALID_ARG Parameter esp_error
 */
esp_err_t esp_timer_set_counter_value(timer_group_t group_num, timer_idx_t timer_num, uint64_t load_val);
 ...
 *     - ESP_ERR_INVALID_ARG Parameter esp_error
 */
esp_err_t esp_timer_start(timer_group_t group_num, timer_idx_t timer_num);
 ...
 *     - ESP_ERR_INVALID_ARG Parameter esp_error
 */
esp_err_t esp_timer_pause(timer_group_t group_num, timer_idx_t timer_num);
 ...
 *     - ESP_ERR_INVALID_ARG Parameter esp_error
 */
esp_err_t esp_timer_set_counter_mode(timer_group_t group_num, timer_idx_t timer_num, timer_count_dir_t counter_dir);
 ...
 *     - ESP_ERR_INVALID_ARG Parameter esp_error
 */
esp_err_t esp_timer_set_auto_reload(timer_group_t group_num, timer_idx_t timer_num, timer_autoreload_t reload);
 ...
 *     - ESP_ERR_INVALID_ARG Parameter esp_error
 */
esp_err_t esp_timer_set_divider(timer_group_t group_num, timer_idx_t timer_num, uint16_t divider);
 ...
 *     - ESP_ERR_INVALID_ARG Parameter esp_error
 */
esp_err_t esp_timer_set_alarm_value(timer_group_t group_num, timer_idx_t timer_num, uint64_t alarm_value);
 ...
 *     - ESP_ERR_INVALID_ARG Parameter esp_error
 */
esp_err_t esp_timer_get_alarm_value(timer_group_t group_num, timer_idx_t timer_num, uint64_t* alarm_value);
 ...
 *     - ESP_ERR_INVALID_ARG Parameter esp_error
 */
esp_err_t esp_timer_set_alarm(timer_group_t group_num, timer_idx_t timer_num, timer_alarm_t alarm_en);
 ...
 *     - ESP_ERR_INVALID_ARG Parameter esp_error
 */
esp_err_t esp_timer_isr_register(timer_group_t group_num, timer_idx_t timer_num, void (*fn)(void*), void * arg, int intr_alloc_flags, timer_isr_handle_t *handle);
 ...
 *     - ESP_ERR_INVALID_ARG Parameter esp_error
 */
esp_err_t esp_timer_init(timer_group_t group_num, timer_idx_t timer_num, timer_config_t* config);
 ...
 *     - ESP_ERR_INVALID_ARG Parameter esp_error
 */
esp_err_t esp_timer_get_config(timer_group_t group_num, timer_idx_t timer_num, timer_config_t *config);
 ...
 *     - ESP_ERR_INVALID_ARG Parameter esp_error
 */
esp_err_t esp_timer_group_intr_enable(timer_group_t group_num, uint32_t en_mask);
 ...
 *     - ESP_ERR_INVALID_ARG Parameter esp_error
 */
esp_err_t esp_timer_group_intr_disable(timer_group_t group_num, uint32_t disable_mask);
 ...
 *     - ESP_ERR_INVALID_ARG Parameter esp_error
 */
esp_err_t esp_timer_enable_intr(timer_group_t group_num, timer_idx_t timer_num);
 ...
 *     - ESP_ERR_INVALID_ARG Parameter esp_error
 */
esp_err_t esp_timer_disable_intr(timer_group_t group_num, timer_idx_t timer_num);
