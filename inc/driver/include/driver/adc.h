 ...
 * esp_adc1_get_voltage() for this channel.
 *
 ...
 *
 * @note Call esp_adc1_config_width() before the first time this
 * function is called.
 *
 * @note For a given channel, esp_adc1_config_channel_atten(channel)
 ...
 *       esp_adc1_config_width() before calling esp_hall_sensor_read(). ADC1
