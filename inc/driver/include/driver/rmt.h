 ...
 *     - ESP_OK Success
 */
esp_err_t esp_rmt_set_clk_div(rmt_channel_t channel, uint8_t div_cnt);
 ...
 *     - ESP_OK Success
 */
esp_err_t esp_rmt_get_clk_div(rmt_channel_t channel, uint8_t* div_cnt);
 ...
 *     - ESP_OK Success
 */
esp_err_t esp_rmt_set_rx_idle_thresh(rmt_channel_t channel, uint16_t thresh);
 ...
 *     - ESP_OK Success
 */
esp_err_t esp_rmt_get_rx_idle_thresh(rmt_channel_t channel, uint16_t *thresh);
 ...
 *     - ESP_OK Success
 */
esp_err_t esp_rmt_set_mem_block_num(rmt_channel_t channel, uint8_t rmt_mem_num);
 ...
 *     - ESP_OK Success
 */
esp_err_t esp_rmt_get_mem_block_num(rmt_channel_t channel, uint8_t* rmt_mem_num);
 ...
 *     - ESP_OK Success
 */
esp_err_t esp_rmt_set_tx_carrier(rmt_channel_t channel, bool carrier_en, uint16_t high_level, uint16_t low_level, rmt_carrier_level_t carrier_level);
 ...
 *     - ESP_OK Success
 */
esp_err_t esp_rmt_set_mem_pd(rmt_channel_t channel, bool pd_en);
 ...
 *     - ESP_OK Success
 */
esp_err_t esp_rmt_get_mem_pd(rmt_channel_t channel, bool* pd_en);
 ...
 *     - ESP_OK Success
 */
esp_err_t esp_rmt_tx_start(rmt_channel_t channel, bool tx_idx_rst);
 ...
 *     - ESP_OK Success
 */
esp_err_t esp_rmt_tx_stop(rmt_channel_t channel);
 ...
 *     - ESP_OK Success
 */
esp_err_t esp_rmt_rx_start(rmt_channel_t channel, bool rx_idx_rst);
 ...
 *     - ESP_OK Success
 */
esp_err_t esp_rmt_rx_stop(rmt_channel_t channel);
 ...
 *     - ESP_OK Success
 */
esp_err_t esp_rmt_memory_rw_rst(rmt_channel_t channel);
 ...
 *     - ESP_OK Success
 */
esp_err_t esp_rmt_set_memory_owner(rmt_channel_t channel, rmt_mem_owner_t owner);
 ...
 *     - ESP_OK Success
 */
esp_err_t esp_rmt_get_memory_owner(rmt_channel_t channel, rmt_mem_owner_t* owner);
 ...
 *     - ESP_OK Success
 */
esp_err_t esp_rmt_set_tx_loop_mode(rmt_channel_t channel, bool loop_en);
 ...
 *     - ESP_OK Success
 */
esp_err_t esp_rmt_get_tx_loop_mode(rmt_channel_t channel, bool* loop_en);
 ...
 *     - ESP_OK Success
 */
esp_err_t esp_rmt_set_rx_filter(rmt_channel_t channel, bool rx_filter_en, uint8_t thresh);
 ...
 *     - ESP_OK Success
 */
esp_err_t esp_rmt_set_source_clk(rmt_channel_t channel, rmt_source_clk_t base_clk);
 ...
 *     - ESP_OK Success
 */
esp_err_t esp_rmt_get_source_clk(rmt_channel_t channel, rmt_source_clk_t* src_clk);
 ...
 *     - ESP_OK Success
 */
esp_err_t esp_rmt_set_idle_level(rmt_channel_t channel, bool idle_out_en, rmt_idle_level_t level);
 ...
 *     - ESP_OK Success
 */
esp_err_t esp_rmt_get_status(rmt_channel_t channel, uint32_t* status);
 ...
 *
 */
void esp_rmt_set_intr_enable_mask(uint32_t mask);
 ...
 *
 */
void esp_rmt_clr_intr_enable_mask(uint32_t mask);
 ...
 *     - ESP_OK Success
 */
esp_err_t esp_rmt_set_rx_intr_en(rmt_channel_t channel, bool en);

/**
 * @brief Set RMT RX esp_error interrupt enable
 *
 * @param channel RMT channel (0 - 7)
 *
 ...
 *     - ESP_OK Success
 */
esp_err_t esp_rmt_set_err_intr_en(rmt_channel_t channel, bool en);
 ...
 *     - ESP_OK Success
 */
esp_err_t esp_rmt_set_pin(rmt_channel_t channel, rmt_mode_t mode, gpio_num_t gpio_num);
 ...
 *     - ESP_OK Success
 */
esp_err_t esp_rmt_config(rmt_config_t* rmt_param);

/**
 * @brief   register RMT interrupt handler, the handler is an ISR.
 *
 *          The handler will be attached to the same CPU core that this function is running on.
 * @note If you already called esp_rmt_driver_install to use system RMT driver,
 ...
 * @return
 *     - ESP_OK Success
 *     - ESP_ERR_INVALID_ARG Function pointer esp_error.
 *     - ESP_FAIL System driver installed, can not register ISR handler for RMT
 */
esp_err_t esp_rmt_isr_register(void (* fn)(void* ), void * arg, int intr_alloc_flags, rmt_isr_handle_t *handle);

/**
 * @brief   Deregister previously registered RMT interrupt handler
 *
 * @param handle Handle obtained from esp_rmt_isr_register
 *
 * @return
 *     - ESP_OK Success
 *     - ESP_ERR_INVALID_ARG Handle invalid
 */
esp_err_t esp_rmt_isr_deregister(rmt_isr_handle_t handle);
 ...
 *     - ESP_OK Success
 */
esp_err_t esp_rmt_fill_tx_items(rmt_channel_t channel, rmt_item32_t* item, uint16_t item_num, uint16_t mem_offset);
 ...
 *     - ESP_OK Success
 */
esp_err_t esp_rmt_driver_uninstall(rmt_channel_t channel);
 ...
 *     - ESP_OK Success
 */
esp_err_t esp_rmt_write_items(rmt_channel_t channel, rmt_item32_t* rmt_item, int item_num, bool wait_tx_done);
 ...
 *     - ESP_OK Success
 */
esp_err_t esp_rmt_wait_tx_done(rmt_channel_t channel);
 ...
 *     - ESP_OK Success
 */
esp_err_t esp_rmt_get_ringbuf_handler(rmt_channel_t channel, RingbufHandle_t* buf_handler);
 ...
 * //this will be done in esp_rmt_config API.
 * esp_periph_module_enable(PERIPH_RMT_MODULE);
 * @endcode
 *
 * @code{c}
 ...
 *     esp_rmt_config(&rmt_rx);
 *
 *     //install system RMT driver.
 *     esp_rmt_driver_install(rmt_rx.channel, 1000, 0);
 * }
 *
 * ----------------EXAMPLE OF RMT INTERRUPT ------------------
 * @code{c}
 *
 * esp_rmt_isr_register(rmt_isr, NULL, 0);           //hook the ISR handler for RMT interrupt
 * @endcode
 * @note
 *     0. If you have called esp_rmt_driver_install, you don't need to set ISR handler any more.
 *
