...
/**
 * @brief Configuration parameters of GPIO pad for esp_gpio_config function
 */
typedef struct {
...
/**
 * @brief GPIO esp_common configuration
 *
 ...
 *
 */
esp_err_t esp_gpio_config(gpio_config_t *pGPIOConfig);
 ...
 *
 */
esp_err_t esp_gpio_set_intr_type(gpio_num_t gpio_num, gpio_int_type_t intr_type);
 ...
 *
 */
esp_err_t esp_gpio_intr_enable(gpio_num_t gpio_num);
 ...
 *
 */
esp_err_t esp_gpio_intr_disable(gpio_num_t gpio_num);
 ...
 * @return
 *     - ESP_OK Success
 *     - ESP_ERR_INVALID_ARG GPIO number esp_error
 *
 */
esp_err_t esp_gpio_set_level(gpio_num_t gpio_num, uint32_t level);
 ...
 *
 */
int esp_gpio_get_level(gpio_num_t gpio_num);
 ...
 * @return
 *     - ESP_OK Success
 *     - ESP_ERR_INVALID_ARG GPIO esp_error
 *
 */
esp_err_t esp_gpio_set_direction(gpio_num_t gpio_num, gpio_mode_t mode);
 ...
 *
 */
esp_err_t esp_gpio_set_pull_mode(gpio_num_t gpio_num, gpio_pull_mode_t pull);
...
/**
  ...
  *     - ESP_ERR_INVALID_ARG Parameter esp_error
  */
esp_err_t esp_gpio_wakeup_disable(gpio_num_t gpio_num);
 ...
 * the alternative esp_gpio_install_isr_service() and
 * esp_gpio_isr_handler_add() API in order to have the driver support
 * per-GPIO ISRs.
 *
 ...
 *     - ESP_ERR_INVALID_ARG GPIO esp_error
 */
esp_err_t esp_gpio_isr_register(void (*fn)(void*), void * arg, int intr_alloc_flags, gpio_isr_handle_t *handle);
...
/**
  ...
  *     - ESP_ERR_INVALID_ARG Parameter esp_error
  */
esp_err_t esp_gpio_pullup_en(gpio_num_t gpio_num);
...
/**
  ...
  *     - ESP_ERR_INVALID_ARG Parameter esp_error
  */
esp_err_t esp_gpio_pullup_dis(gpio_num_t gpio_num);
...
/**
  ...
  *     - ESP_ERR_INVALID_ARG Parameter esp_error
  */
esp_err_t esp_gpio_pulldown_en(gpio_num_t gpio_num);
...
/**
  ...
  *     - ESP_ERR_INVALID_ARG Parameter esp_error
  */
esp_err_t esp_gpio_pulldown_dis(gpio_num_t gpio_num);

/**
  * @brief Install the driver's GPIO ISR handler service, which allows per-pin GPIO interrupt handlers.
  *
  * This function is incompatible with esp_gpio_isr_register() - if that function is used, a single global ISR is registered for all GPIO interrupts. If this function is used, the ISR service provides a global GPIO ISR and individual pin handlers are registered via the esp_gpio_isr_register() function.
  *
  * @param intr_alloc_flags Flags used to allocate the interrupt. One or multiple (ORred)
  *            ESP_INTR_FLAG_* values. See esp_esp_intr_alloc.h for more info.
  *
  ...
  */
esp_err_t esp_gpio_install_isr_service(int intr_alloc_flags);

/**
  * @brief Uninstall the driver's GPIO ISR service, freeing related resources.
  */
void esp_gpio_uninstall_isr_service();

/**
  * @brief Add ISR handler for the corresponding GPIO pin.
  *
  * Call this function after using esp_gpio_install_isr_service() to
  ...
  * ISR in esp_gpio_install_isr_service().
  *
  ...
  *     - ESP_ERR_INVALID_ARG Parameter esp_error
  */
esp_err_t esp_gpio_isr_handler_add(gpio_num_t gpio_num, gpio_isr_t isr_handler, void* args);
...
/**
  ...
  *     - ESP_ERR_INVALID_ARG Parameter esp_error
  */
esp_err_t esp_gpio_isr_handler_remove(gpio_num_t gpio_num);
