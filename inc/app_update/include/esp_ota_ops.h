...
#define ESP_ERR_OTA_SELECT_INFO_INVALID          (ESP_ERR_OTA_BASE + 0x02)  /*!< ota data partition info is esp_error */
#define ESP_ERR_OTA_VALIDATE_FAILED              (ESP_ERR_OTA_BASE + 0x03)  /*!< validate ota image failed */

/**
 * @brief Opaque handle for application esp_update obtained from app_ops.
 */
 ...
 * @param   out_handle handle which should be used for esp_esp_ota_write or esp_esp_ota_end call
...
/**
 * @brief   Finish the esp_update and validate written data
 *
 * @param   handle  Handle obtained from esp_esp_ota_begin 
 *
 * @return: 
...
/**
 * @brief   Set next boot partition, call esp_system_restart() will switch to run it
 *
