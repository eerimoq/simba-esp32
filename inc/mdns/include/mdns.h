 ...
 *     - ESP_ERR_INVALID_STATE when the network returned esp_error
 *     - ESP_ERR_NO_MEM on memory esp_error
 *     - ESP_ERR_WIFI_NOT_INIT when WiFi is not initialized by eps_wifi_init
 */
esp_err_t esp_mdns_init(tcpip_adapter_if_t tcpip_if, mdns_server_t ** server);
 ...
 *
 */
void esp_mdns_free(mdns_server_t * server);
 ...
 *     - ESP_ERR_NO_MEM memory esp_error
 */
esp_err_t esp_mdns_set_hostname(mdns_server_t * server, const char * hostname);
 ...
 *     - ESP_ERR_NO_MEM memory esp_error
 */
esp_err_t esp_mdns_set_instance(mdns_server_t * server, const char * instance);
 ...
 *     - ESP_ERR_NO_MEM memory esp_error
 */
esp_err_t esp_mdns_service_add(mdns_server_t * server, const char * service, const char * proto, uint16_t port);
 ...
 *     - ESP_FAIL unknown esp_error
 */
esp_err_t esp_mdns_service_remove(mdns_server_t * server, const char * service, const char * proto);
 ...
 *     - ESP_ERR_NO_MEM memory esp_error
 */
esp_err_t esp_mdns_service_instance_set(mdns_server_t * server, const char * service, const char * proto, const char * instance);
 ...
 *     - ESP_ERR_NO_MEM memory esp_error
 */
esp_err_t esp_mdns_service_txt_set(mdns_server_t * server, const char * service, const char * proto, uint8_t num_items, const char ** txt);
 ...
 *     - ESP_ERR_NOT_FOUND Service not found
 */
esp_err_t esp_mdns_service_port_set(mdns_server_t * server, const char * service, const char * proto, uint16_t port);
 ...
 *     - ESP_ERR_INVALID_ARG Parameter esp_error
 */
esp_err_t esp_mdns_service_remove_all(mdns_server_t * server);
 ...
 * @param  timeout      time to wait for answers. If 0, esp_mdns_query_end MUST be called to end the search
 *
 * @return the number of results found
 */
size_t esp_mdns_query(mdns_server_t * server, const char * service, const char * proto, uint32_t timeout);
 ...
 * @return the number of results found
 */
size_t esp_mdns_query_end(mdns_server_t * server);
 ...
 */
size_t esp_mdns_result_get_count(mdns_server_t * server);
 ...
 *
 * @return the result or NULL if esp_error
 */
const mdns_result_t * esp_mdns_result_get(mdns_server_t * server, size_t num);
 ...
 *     - ESP_ERR_INVALID_ARG Parameter esp_error
 */
esp_err_t esp_mdns_result_free(mdns_server_t * server);
