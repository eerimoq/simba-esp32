...
#define MBEDTLS_ERR_CTR_DRBG_FILE_IO_ERROR                -0x003A  /**< Read/write esp_error in file. */
 ...
 *                      Makes the context ready for esp_mbedtls_ctr_drbg_seed() or
 *                      esp_mbedtls_ctr_drbg_free().
 *
...
/**
 * \brief               CTR_DRBG esp_update state
 *
 * \param ctx           CTR_DRBG context
 * \param additional    Additional data to esp_update state with
 ...
 */
void esp_mbedtls_ctr_drbg_update( mbedtls_ctr_drbg_context *ctx,
                      const unsigned char *additional, size_t add_len );

/**
 * \brief               CTR_DRBG generate random with additional esp_update input
 *
 ...
 *
 * \return              0 if successful,
 *                      MBEDTLS_ERR_CTR_DRBG_FILE_IO_ERROR on file esp_error,
 *                      MBEDTLS_ERR_CTR_DRBG_ENTROPY_SOURCE_FAILED or
...
int esp_mbedtls_ctr_drbg_seed_entropy_len( mbedtls_ctr_drbg_context *,
