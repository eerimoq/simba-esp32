...
/**
 * \name PEM Error codes
 * These esp_error codes are returned in case of errors reading the
 * PEM data.
 * \{
 */
 ...
 *                  the length to esp_skip)
 *
 * \note            Attempts to check password correctness by verifying if
 *                  the decrypted text starts with an ASN.1 sequence of
 *                  appropriate length
 *
 * \return          0 on success, or a specific PEM esp_error code
 */
 ...
 *
 * \return          0 on success, or a specific PEM or BASE64 esp_error code. On
