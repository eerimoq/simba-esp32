 ...
 *
 * \return         0 if successful, or an MBEDTLS_ERR_DHM_XXX esp_error code
 */
 ...
 *                 using esp_mbedtls_mpi_read_string or esp_mbedtls_mpi_read_binary).
 *
 * \return         0 if successful, or an MBEDTLS_ERR_DHM_XXX esp_error code
 */
 ...
 *
 * \return         0 if successful, or a specific DHM or PEM esp_error code
 */
