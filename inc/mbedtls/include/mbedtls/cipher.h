 ...
 *                      will be required to call esp_mbedtls_cipher_init() on the structure
 *                      first.
 *
 ...
 */
int esp_mbedtls_cipher_setup( mbedtls_cipher_context_t *ctx, const mbedtls_cipher_info_t *cipher_info );
 ...
 *                      esp_error code.
 */
int esp_mbedtls_cipher_setkey( mbedtls_cipher_context_t *ctx, const unsigned char *key,
 ...
 *                      Must be called exactly once, after esp_mbedtls_cipher_reset().
 *
 * \param ctx           generic cipher context
...
/**
 * \brief               Generic cipher esp_update function. Encrypts/decrypts
 ...
 *                      function, except the last one before esp_mbedtls_cipher_finish(),
 ...
 *                      Currently only supported with GCM.
 *                      Must be called after esp_mbedtls_cipher_finish().
 *
 * \param ctx           Generic cipher context
 ...
 *                      a cipher specific esp_error code.
 */
int esp_mbedtls_cipher_auth_encrypt( mbedtls_cipher_context_t *ctx,
                         const unsigned char *iv, size_t iv_len,
                         const unsigned char *ad, size_t ad_len,
                         const unsigned char *input, size_t ilen,
                         unsigned char *output, size_t *olen,
