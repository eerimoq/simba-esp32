 ...
 *                  attacks, see \c esp_mbedtls_ecp_mul() for details.
 */
 ...
 *                  properly set (for example using esp_mbedtls_ecp_group_load).
 *
 * \return          0 if successful, or an MBEDTLS_ERR_ECP_XXX esp_error code
 */
 ...
 * \return          0 if successful, or an MBEDTLS_ERR_ECP_XXX esp_error code
 */
int esp_mbedtls_ecdh_get_params( mbedtls_ecdh_context *ctx, const mbedtls_ecp_keypair *key,
 ...
 * \param f_rng     RNG function, see notes for \c esp_mbedtls_ecdh_compute_shared()
 * \param p_rng     RNG parameter
 *
 * \return          0 if successful, or an MBEDTLS_ERR_ECP_XXX esp_error code
 */
