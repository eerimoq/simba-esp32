...
typedef struct {
    ...
    uint32_t update_clk_reg: 1;     ///< 0: normal command, 1: don't send command, just esp_update clock registers
...
typedef volatile struct {
    ...
    union {
        struct {
            ...
            uint32_t re: 1;             ///< Response esp_error interrupt enable
            ...
            uint32_t rcrc: 1;           ///< Response CRC esp_error interrupt enable
            uint32_t dcrc: 1;           ///< Data CRC esp_error interrupt enable
            ...
            uint32_t frun: 1;           ///< FIFO underrun/overrun esp_error interrupt enable
            uint32_t hle: 1;            ///< Hardware locked write esp_error interrupt enable
            uint32_t sbi_bci: 1;        ///< Start bit esp_error / busy clear interrupt enable
            uint32_t acd: 1;            ///< Auto command done interrupt enable
            uint32_t ebe: 1;            ///< End bit esp_error / write no CRC interrupt enable
    ...
    union {
        struct {
            ...
            uint32_t re: 1;             ///< Response esp_error interrupt masked status
            ...
            uint32_t rcrc: 1;           ///< Response CRC esp_error interrupt masked status
            uint32_t dcrc: 1;           ///< Data CRC esp_error interrupt masked status
            ...
            uint32_t frun: 1;           ///< FIFO underrun/overrun esp_error interrupt masked status
            uint32_t hle: 1;            ///< Hardware locked write esp_error interrupt masked status
            uint32_t sbi_bci: 1;        ///< Start bit esp_error / busy clear interrupt masked status
            uint32_t acd: 1;            ///< Auto command done interrupt masked status
            uint32_t ebe: 1;            ///< End bit esp_error / write no CRC interrupt masked status
    ...
    union {
        struct {
            ...
            uint32_t re: 1;             ///< Response esp_error raw interrupt status
            ...
            uint32_t rcrc: 1;           ///< Response CRC esp_error raw interrupt status
            uint32_t dcrc: 1;           ///< Data CRC esp_error raw interrupt status
            ...
            uint32_t frun: 1;           ///< FIFO underrun/overrun esp_error raw interrupt status
            uint32_t hle: 1;            ///< Hardware locked write esp_error raw interrupt status
            uint32_t sbi_bci: 1;        ///< Start bit esp_error / busy clear raw interrupt status
            uint32_t acd: 1;            ///< Auto command done raw interrupt status
            uint32_t ebe: 1;            ///< End bit esp_error / write no CRC raw interrupt status
    ...
    union {
        struct {
            ...
            uint32_t dsl: 5;            ///< descriptor esp_skip length: number of words to esp_skip between two unchained descriptors
    ...
    union {
        struct {
            ...
            uint32_t fbe: 1;        ///< fatal bus esp_error
            uint32_t reserved1: 1;
            uint32_t du: 1;         ///< descriptor unavailable
            uint32_t ces: 1;        ///< card esp_error summary
            uint32_t reserved2: 2;
            uint32_t nis: 1;        ///< normal interrupt summary
            uint32_t fbe_code: 3;   ///< code of fatal bus esp_error
    ...
    union {
        struct {
            ...
            uint32_t fbe: 1;        ///< fatal bus esp_error interrupt enable
            uint32_t reserved1: 1;
            uint32_t du: 1;         ///< descriptor unavailable interrupt enable
            uint32_t ces: 1;        ///< card esp_error interrupt enable
            uint32_t reserved2: 2;
