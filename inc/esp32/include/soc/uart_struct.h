...
typedef volatile struct {
    ...
    union {
        struct {
            ...
            uint32_t parity_err:       1;           /*This interrupt raw bit turns to high level when receiver detects the parity esp_error of data.*/
            uint32_t frm_err:          1;           /*This interrupt raw bit turns to high level when receiver detects data's frame esp_error .*/
            ...
            uint32_t rs485_parity_err: 1;           /*This interrupt raw bit turns to high level when rs485 detects the parity esp_error.*/
            uint32_t rs485_frm_err:    1;           /*This interrupt raw bit turns to high level when rs485 detects the data frame esp_error.*/
