...
typedef volatile struct {
    ...
    union {
        struct {
            ...
            uint32_t outlink_dscr_error: 1;                 /*The enable bit for outlink descriptor esp_error.*/
            uint32_t inlink_dscr_error:  1;                 /*The enable bit for inlink descriptor esp_error.*/
            uint32_t in_done:            1;                 /*The enable bit for completing usage of a inlink descriptor.*/
            uint32_t in_err_eof:         1;                 /*The enable bit for receiving esp_error.*/
    ...
    union {
        struct {
            ...
            uint32_t outlink_dscr_error: 1;                 /*The raw bit for outlink descriptor esp_error.*/
            uint32_t inlink_dscr_error:  1;                 /*The raw bit for inlink descriptor esp_error.*/
            uint32_t in_done:            1;                 /*The raw bit for completing usage of a inlink descriptor.*/
            uint32_t in_err_eof:         1;                 /*The raw bit for receiving esp_error.*/
    ...
    union {
        struct {
            ...
            uint32_t outlink_dscr_error: 1;                  /*The status bit for outlink descriptor esp_error.*/
            uint32_t inlink_dscr_error:  1;                  /*The status bit for inlink descriptor esp_error.*/
            uint32_t in_done:            1;                  /*The status bit for completing usage of a inlink descriptor.*/
            uint32_t in_err_eof:         1;                  /*The status bit for receiving esp_error.*/
    ...
    union {
        struct {
            ...
            uint32_t outlink_dscr_error: 1;                 /*The clear bit for outlink descriptor esp_error.*/
            uint32_t inlink_dscr_error:  1;                 /*The clear bit for inlink descriptor esp_error.*/
            uint32_t in_done:            1;                 /*The clear bit for completing usage of a inlink descriptor.*/
            uint32_t in_err_eof:         1;                 /*The clear bit for receiving esp_error.*/
    ...
    uint32_t dma_in_err_eof_des_addr;                       /*The inlink descriptor address when spi dma produce receiving esp_error.*/
