 ...
 *     PIN_PULLUP_EN(GPIO_PIN_MUX_REG[x])   ->  esp_gpio_pullup_en(x)
 *     PIN_PULLUP_DIS(GPIO_PIN_MUX_REG[x])  ->  esp_gpio_pullup_dis(x)
 *     PIN_PULLDWN_EN(GPIO_PIN_MUX_REG[x])  ->  esp_gpio_pulldown_en(x)
 *     PIN_PULLDWN_DIS(GPIO_PIN_MUX_REG[x]) ->  esp_gpio_pulldown_dis(x)
 *
*/
