 ...
 * esp_esp_ipc_call_blocking.
 */
void esp_esp_ipc_init();
 ...
 *         ESP_OK otherwise
 */
esp_err_t esp_esp_ipc_call(uint32_t cpu_id, esp_ipc_func_t func, void* arg);
 ...
 *         ESP_OK otherwise
 */
esp_err_t esp_esp_ipc_call_blocking(uint32_t cpu_id, esp_ipc_func_t func, void* arg);
