...
/**
  ...
  */
const char *esp_esp_smartconfig_get_version(void);
...
/**
  ...
  * @attention 2. Can not call esp_esp_smartconfig_start twice before it finish, please call
  *               esp_esp_smartconfig_stop first.
  *
  ...
  *     - others: fail
  */
esp_err_t esp_esp_smartconfig_start(sc_callback_t cb, ...);

/**
  * @brief     Stop SmartConfig, free the buffer taken by esp_esp_smartconfig_start.
  *
  ...
  *     - others: fail
  */
esp_err_t esp_esp_smartconfig_stop(void);
...
/**
  ...
  *     - others: fail
  */
esp_err_t esp_esp_smartconfig_set_type(smartconfig_type_t type);

/**
  * @brief     Set mode of SmartConfig. default normal mode.
  *
  * @attention 1. Please call it before API esp_esp_smartconfig_start.
  ...
  *     - others: fail
  */
esp_err_t esp_esp_smartconfig_fast_mode(bool enable);
