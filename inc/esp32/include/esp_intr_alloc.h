 ...
 * code calling esp_esp_intr_alloc* needs.
 *
 */
...
/**
 * The esp_esp_intr_alloc* functions can allocate an int for all ETS_*_INTR_SOURCE interrupt sources that
 ...
 *         ESP_OK otherwise
 */
esp_err_t esp_esp_intr_mark_shared(int intno, int cpu, bool is_in_iram);
 ...
 *         ESP_OK otherwise
 */
esp_err_t esp_esp_intr_reserve(int intno, int cpu);
 ...
 *         ESP_OK otherwise
 */
esp_err_t esp_esp_intr_alloc(int source, int flags, intr_handler_t handler, void *arg, intr_handle_t *ret_handle);
 ...
 *
 *
 * This essentially does the same as esp_esp_intr_alloc, but allows specifying a register and mask
 ...
 *         ESP_OK otherwise
 */
esp_err_t esp_esp_intr_alloc_intrstatus(int source, int flags, uint32_t intrstatusreg, uint32_t intrstatusmask, intr_handler_t handler, void *arg, intr_handle_t *ret_handle);
 ...
 * associated with it.
 *
 * @param handle The handle, as obtained by esp_esp_intr_alloc or esp_esp_intr_alloc_intrstatus
 *
 * @return ESP_ERR_INVALID_ARG if handle is invalid, or esp_esp_intr_free runs on another core than
 *                             where the interrupt is allocated on.
 *         ESP_OK otherwise
 */
esp_err_t esp_esp_intr_free(intr_handle_t handle);
 ...
 */
int esp_esp_intr_get_cpu(intr_handle_t handle);
 ...
 */
int esp_esp_intr_get_intno(intr_handle_t handle);
 ...
 *         ESP_OK otherwise
 */
esp_err_t esp_esp_intr_disable(intr_handle_t handle);
 ...
 *         ESP_OK otherwise
 */
esp_err_t esp_esp_intr_enable(intr_handle_t handle);


/**
 * @brief Disable interrupts that aren't specifically marked as running from IRAM
 */
void esp_esp_intr_noniram_disable();


/**
 * @brief Re-enable interrupts disabled by esp_esp_intr_noniram_disable
 */
void esp_esp_intr_noniram_enable();
