...
#define ESP_ERR_WIFI_WPS_TYPE    (ESP_ERR_WIFI_BASE + 52)  /*!< WPS type esp_error */
...
/**
  ...
  */
esp_err_t esp_esp_wifi_wps_enable(wps_type_t wps_type);
...
/**
  ...
  *          - ESP_ERR_WIFI_WPS_MODE : wifi is not in station mode or sniffer mode is on
  */
esp_err_t esp_esp_wifi_wps_disable(void);
...
/**
  ...
  *          - ESP_ERR_WIFI_FAIL : wps initialization fails
  */
esp_err_t esp_esp_wifi_wps_start(int timeout_ms);
