 ...
 * or post event queue to a specified Queue, which is initialized by API esp_esp_wifi_init().
 *
 ...
 * on receiving event SYSTEM_EVENT_STA_CONNECTED, it will call esp_tcpip_adapter_start() to start the DHCP
 ...
 *
 * The application task (code) generally mixes all these thing together, it calls APIs to esp_init the system/WiFi and
...
#define ESP_ERR_WIFI_OK          ESP_OK                    /*!< No esp_error */
...
#define ESP_ERR_WIFI_NOT_INIT    (ESP_ERR_WIFI_BASE + 1)   /*!< WiFi driver is not installed by esp_esp_wifi_init */
#define ESP_ERR_WIFI_NOT_START   (ESP_ERR_WIFI_BASE + 2)   /*!< WiFi driver is not started by esp_esp_wifi_start */
#define ESP_ERR_WIFI_IF          (ESP_ERR_WIFI_BASE + 3)   /*!< WiFi interface esp_error */
#define ESP_ERR_WIFI_MODE        (ESP_ERR_WIFI_BASE + 4)   /*!< WiFi mode esp_error */
#define ESP_ERR_WIFI_STATE       (ESP_ERR_WIFI_BASE + 5)   /*!< WiFi internal state esp_error */
#define ESP_ERR_WIFI_CONN        (ESP_ERR_WIFI_BASE + 6)   /*!< WiFi internal control block of station or soft-AP esp_error */
#define ESP_ERR_WIFI_NVS         (ESP_ERR_WIFI_BASE + 7)   /*!< WiFi internal NVS module esp_error */
...
#define ESP_ERR_WIFI_TIMEOUT     (ESP_ERR_WIFI_BASE + 11)  /*!< Timeout esp_error */
#define ESP_ERR_WIFI_WAKE_FAIL   (ESP_ERR_WIFI_BASE + 12)  /*!< WiFi is in sleep state(RF closed) and wakeup fail */

/**
 * @brief WiFi stack configuration parameters passed to esp_esp_wifi_init call.
 */
typedef struct {
...
#define WIFI_INIT_CONFIG_DEFAULT() { \
    .event_handler = &esp_esp_event_send, \
};
...
/**
  ...
  * @attention 2. Generally we should esp_init event_q in *config, WiFi driver will post the event
  ...
  *
  * @param  config provide WiFi esp_init configuration
  *
  * @return
  *    - ESP_OK: succeed
  *    - ESP_ERR_WIFI_NO_MEM: out of memory
  *    - others: refer to esp_error code esp_err.h 
  */
esp_err_t esp_esp_wifi_init(wifi_init_config_t *config);

/**
  * @brief  Deinit WiFi
  *         Free all resource allocated in esp_esp_wifi_init and stop WiFi task
  *
  * @attention 1. This API should be called if you want to remove WiFi driver from the system
  *
  * @return ESP_OK: succeed
  */
esp_err_t esp_esp_wifi_deinit(void);
...
/**
  ...
  *    - others: refer to esp_error code in esp_err.h
  */
esp_err_t esp_esp_wifi_set_mode(wifi_mode_t mode);
...
/**
  ...
  *    - ESP_ERR_WIFI_ARG: invalid argument
  */
esp_err_t esp_esp_wifi_get_mode(wifi_mode_t *mode);
...
/**
  ...
  *    - ESP_ERR_WIFI_ARG: invalid argument
  *    - ESP_ERR_WIFI_NO_MEM: out of memory
  *    - ESP_ERR_WIFI_CONN: WiFi internal esp_error, station or soft-AP control block wrong
  *    - ESP_ERR_WIFI_FAIL: other WiFi internal errors
  */
esp_err_t esp_esp_wifi_start(void);
...
/**
  ...
  *    - ESP_ERR_WIFI_NOT_INIT: WiFi is not initialized by eps_wifi_init
  */
esp_err_t esp_esp_wifi_stop(void);

/**
 * @brief  Restore WiFi stack persistent settings to default values
 *
 * This function will reset settings made using the following APIs:
 * - esp_esp_wifi_get_auto_connect,
 * - esp_esp_wifi_set_protocol,
 * - esp_esp_wifi_set_config related
 * - esp_esp_wifi_set_mode
 *
 * @return
 *    - ESP_OK: succeed
 *    - ESP_ERR_WIFI_NOT_INIT: WiFi is not initialized by eps_wifi_init
 */
esp_err_t esp_esp_wifi_restore(void);

/**
  * @brief     Connect the ESP32 WiFi station to the AP.
  *
  * @attention 1. This API only impact WIFI_MODE_STA or WIFI_MODE_APSTA mode
  * @attention 2. If the ESP32 is connected to an AP, call esp_esp_wifi_disconnect to disconnect.
  *
  * @return 
  *    - ESP_OK: succeed
  *    - ESP_ERR_WIFI_NOT_INIT: WiFi is not initialized by eps_wifi_init
  *    - ESP_ERR_WIFI_NOT_START: WiFi is not started by esp_esp_wifi_start
  *    - ESP_ERR_WIFI_CONN: WiFi internal esp_error, station or soft-AP control block wrong
  *    - ESP_ERR_WIFI_SSID: SSID of AP which station connects is invalid
  */
esp_err_t esp_esp_wifi_connect(void);
...
/**
  ...
  *    - ESP_ERR_WIFI_FAIL: other WiFi internal errors
  */
esp_err_t esp_esp_wifi_disconnect(void);
...
/**
  ...
  *    - others: fail
  */
esp_err_t esp_esp_wifi_clear_fast_connect(void);
...
/**
  ...
  */
esp_err_t esp_esp_wifi_deauth_sta(uint16_t aid);
...
/**
  ...
  *    - others: refer to esp_error code in esp_err.h
  */
esp_err_t esp_esp_wifi_scan_start(wifi_scan_config_t *config, bool block);
...
/**
  ...
  *    - ESP_ERR_WIFI_NOT_START: WiFi is not started by esp_esp_wifi_start
  */
esp_err_t esp_esp_wifi_scan_stop(void);
...
/**
  ...
  *    - ESP_ERR_WIFI_ARG: invalid argument
  */
esp_err_t esp_esp_wifi_scan_get_ap_num(uint16_t *number);
...
/**
  ...
  *    - ESP_ERR_WIFI_NO_MEM: out of memory
  */
esp_err_t esp_esp_wifi_scan_get_ap_records(uint16_t *number, wifi_ap_record_t *ap_records);
...
/**
  ...
  *    - others: fail
  */
esp_err_t esp_esp_wifi_sta_get_ap_info(wifi_ap_record_t *ap_info);
...
/**
  ...
  */
esp_err_t esp_esp_wifi_set_ps(wifi_ps_type_t type);
...
/**
  ...
  * @return    ESP_ERR_WIFI_NOT_SUPPORT: not supported yet
  */
esp_err_t esp_esp_wifi_get_ps(wifi_ps_type_t *type);
...
/**
  ...
  *    - others: refer to esp_error codes in esp_err.h
  */
esp_err_t esp_esp_wifi_set_protocol(wifi_interface_t ifx, uint8_t protocol_bitmap);
...
/**
  ...
  *    - others: refer to esp_error codes in esp_err.h
  */
esp_err_t esp_esp_wifi_get_protocol(wifi_interface_t ifx, uint8_t *protocol_bitmap);
...
/**
  ...
  *    - others: refer to esp_error codes in esp_err.h
  */
esp_err_t esp_esp_wifi_set_bandwidth(wifi_interface_t ifx, wifi_bandwidth_t bw);
...
/**
  ...
  *    - ESP_ERR_WIFI_ARG: invalid argument
  */
esp_err_t esp_esp_wifi_get_bandwidth(wifi_interface_t ifx, wifi_bandwidth_t *bw);
...
/**
  ...
  *    - ESP_ERR_WIFI_ARG: invalid argument
  */
esp_err_t esp_esp_wifi_set_channel(uint8_t primary, wifi_second_chan_t second);
...
/**
  ...
  *    - ESP_ERR_WIFI_ARG: invalid argument
  */
esp_err_t esp_esp_wifi_get_channel(uint8_t *primary, wifi_second_chan_t *second);
...
/**
  ...
  *    - others: refer to esp_error code in esp_err.h
  */
esp_err_t esp_esp_wifi_set_country(wifi_country_t country);
...
/**
  ...
  *    - ESP_ERR_WIFI_ARG: invalid argument
  */
esp_err_t esp_esp_wifi_get_country(wifi_country_t *country);
...
/**
  ...
  *    - others: refer to esp_error codes in esp_err.h
  */
esp_err_t esp_esp_wifi_set_mac(wifi_interface_t ifx, uint8_t mac[6]);
...
/**
  ...
  *    - ESP_ERR_WIFI_IF: invalid interface
  */
esp_err_t esp_esp_wifi_get_mac(wifi_interface_t ifx, uint8_t mac[6]);
...
/**
  ...
  *    - ESP_ERR_WIFI_NOT_INIT: WiFi is not initialized by eps_wifi_init
  */
esp_err_t esp_esp_wifi_set_promiscuous_rx_cb(wifi_promiscuous_cb_t cb);
...
/**
  ...
  *    - ESP_ERR_WIFI_NOT_INIT: WiFi is not initialized by eps_wifi_init
  */
esp_err_t esp_esp_wifi_set_promiscuous(bool en);
...
/**
  ...
  *    - ESP_ERR_WIFI_ARG: invalid argument
  */
esp_err_t esp_esp_wifi_get_promiscuous(bool *en);
...
/**
  ...
  *    - ESP_ERR_WIFI_NVS: WiFi internal NVS esp_error
  *    - others: refer to the erro code in esp_err.h
  */
esp_err_t esp_esp_wifi_set_config(wifi_interface_t ifx, wifi_config_t *conf);
...
/**
  ...
  *    - ESP_ERR_WIFI_IF: invalid interface
  */
esp_err_t esp_esp_wifi_get_config(wifi_interface_t ifx, wifi_config_t *conf);
...
/**
  ...
  *    - ESP_ERR_WIFI_ARG: invalid argument
  *    - ESP_ERR_WIFI_MODE: WiFi mode is wrong
  *    - ESP_ERR_WIFI_CONN: WiFi internal esp_error, the station/soft-AP control block is invalid
  */
esp_err_t esp_esp_wifi_ap_get_sta_list(wifi_sta_list_t *sta);
...
/**
  ...
  *   - ESP_ERR_WIFI_ARG: invalid argument
  */
esp_err_t esp_esp_wifi_set_storage(wifi_storage_t storage);
...
/**
  ...
  *    - ESP_OK: succeed
  *    - ESP_ERR_WIFI_NOT_INIT: WiFi is not initialized by eps_wifi_init
  *    - ESP_ERR_WIFI_MODE: WiFi internal esp_error, the station/soft-AP control block is invalid
  *    - others: refer to esp_error code in esp_err.h
  */
esp_err_t esp_esp_wifi_set_auto_connect(bool en);
...
/**
  ...
  *    - ESP_ERR_WIFI_ARG: invalid argument
  */
esp_err_t esp_esp_wifi_get_auto_connect(bool *en);
...
/**
  ...
  *    - ESP_ERR_WIFI_NO_MEM: out of memory
  */
esp_err_t esp_esp_wifi_set_vendor_ie(bool enable, wifi_vendor_ie_type_t type, wifi_vendor_ie_id_t idx, uint8_t *vnd_ie);
...
/**
  ...
  *    - ESP_ERR_WIFI_NOT_INIT: WiFi is not initialized by eps_wifi_init
  */
esp_err_t esp_esp_wifi_set_vendor_ie_cb(esp_vendor_ie_cb_t cb, void *ctx);
