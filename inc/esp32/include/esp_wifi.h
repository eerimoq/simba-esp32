...
#define ESP_ERR_WIFI_NOT_INIT    (ESP_ERR_WIFI_BASE + 1)   /*!< WiFi driver was not installed by esp_esp_wifi_init */
#define ESP_ERR_WIFI_NOT_STARTED (ESP_ERR_WIFI_BASE + 2)   /*!< WiFi driver was not started by esp_esp_wifi_start */
...
/**
  ...
  *    - ESP_ERR_WIFI_NOT_STARTED: WiFi was not started by esp_esp_wifi_start
  *    - ESP_ERR_WIFI_FAIL: other WiFi internal errors
  */
...
/**
  ...
  *    - ESP_OK: succeed
  *    - ESP_ERR_WIFI_NOT_INIT: WiFi is not initialized by eps_wifi_init
  *    - ESP_ERR_WIFI_NOT_STARTED: WiFi is not started by esp_esp_wifi_start
  */
...
/**
  ...
  * @attention 2. This API should be called after esp_esp_wifi_start() or esp_esp_wifi_set_promiscuous()
  *
