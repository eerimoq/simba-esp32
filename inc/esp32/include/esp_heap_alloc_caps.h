 ...
 * be re-enabled.
 */
void esp_heap_alloc_enable_nonos_stack_tag();
 ...
 */
void *esp_pvPortMallocCaps(size_t xWantedSize, uint32_t caps);
 ...
 */
size_t esp_xPortGetFreeHeapSizeCaps( uint32_t caps );
 ...
 * @return Amount of free bytes in the regions
 */
size_t esp_xPortGetMinimumEverFreeHeapSizeCaps( uint32_t caps );
