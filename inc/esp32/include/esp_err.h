...
/* Definitions for esp_error constants. */
...
#define ESP_ERR_WIFI_BASE       0x3000 /*!< Starting number of WiFi esp_error codes */
...
/**
 * Macro which can be used to check the esp_error code,
 * and terminate the program in case the code is not ESP_OK.
 * Prints the esp_error code, esp_error location, and the failed statement to serial output.
 *
