...
/**
  * @brief  Do a efuse read operation, to esp_update the efuse value to efuse read registers.
  *
  * @param  null
  *
  * @return null
...
/**
  * @brief  Do a efuse write operation, to esp_update efuse write registers to efuse, then you need call ets_efuse_read_op again.
  *
  * @param  null
  *
  * @return null
