...
/**
  ...
  * @return None
  */
void esp_ets_timer_arm(ETSTimer *timer, uint32_t tmout, bool repeat);
...
/**
  ...
  * @return None
  */
void esp_ets_timer_arm_us(ETSTimer *ptimer, uint32_t us, bool repeat);
...
/**
  ...
  * @return None
  */
void esp_ets_timer_disarm(ETSTimer *timer);
...
/**
  ...
  * @return None
  */
void esp_ets_timer_setfn(ETSTimer *ptimer, ETSTimerFunc *pfunction, void *parg);
...
/**
  ...
  * @return None
  */
void esp_ets_timer_done(ETSTimer *ptimer);
...
/**
  ...
  * @return None
  */
void esp_ets_isr_mask(uint32_t mask);
...
/**
  ...
  * @return None
  */
void esp_ets_isr_unmask(uint32_t unmask);
...
/**
  ...
  *         2.Set interrupt handler.                    esp_xt_set_interrupt_handler(ETS_WMAC_INUM, func, NULL);
  *         3.Enable interrupt for CPU.                 esp_xt_ints_on(1 << ETS_WMAC_INUM);
...
#define ETS_INTR_ENABLE(inum) \
        esp_ets_isr_unmask((1<<inum))

#define ETS_INTR_DISABLE(inum) \
        esp_ets_isr_mask((1<<inum))
