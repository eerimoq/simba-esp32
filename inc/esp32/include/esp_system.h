...
/**
  ...
  */
void esp_system_init(void) __attribute__ ((deprecated));

/**
  * @brief  Reset to default settings.
  *
  * Function has been deprecated, please use esp_esp_wifi_restore instead.
  * This name will be removed in a future release.
  */
void esp_system_restore(void) __attribute__ ((deprecated));
...
/**
  ...
  */
void esp_esp_restart(void) __attribute__ ((noreturn));

/**
  * @brief  Restart system.
  *
  * Function has been renamed to esp_esp_restart.
  * This name will be removed in a future release.
  */
void esp_system_restart(void) __attribute__ ((deprecated, noreturn));
...
/**
  ...
  */
uint32_t esp_esp_get_free_heap_size(void);

/**
  * @brief  Get the size of available heap.
  *
  * Function has been renamed to esp_esp_get_free_heap_size.
  * This name will be removed in a future release.
  *
  * @return Available heap size, in bytes.
  */
uint32_t esp_system_get_free_heap_size(void)  __attribute__ ((deprecated));
...
/**
  ...
  */
esp_err_t esp_esp_efuse_read_mac(uint8_t* mac);

/**
  * @brief  Read hardware MAC address.
  *
  * Function has been renamed to esp_esp_efuse_read_mac.
  * This name will be removed in a future release.
  *
  * @param  mac  hardware MAC address, length: 6 bytes.
  * @return ESP_OK on success
  */
esp_err_t esp_system_efuse_read_mac(uint8_t mac[6]) __attribute__ ((deprecated));
...
/**
  ...
  * @return ESP_OK on success
  */
esp_err_t esp_esp_read_mac(uint8_t* mac, esp_mac_type_t type);
...
/**
  ...
  * @return ESP_OK on success
  */
esp_err_t esp_esp_derive_mac(uint8_t* dst_mac, const uint8_t* src_mac);
 ...
 */
const char* esp_system_get_sdk_version(void)  __attribute__ ((deprecated));
 ...
 */
const char* esp_esp_get_idf_version(void);
