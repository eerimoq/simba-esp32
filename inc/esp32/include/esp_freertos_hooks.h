...
/**
  ...
  */
esp_err_t esp_esp_register_freertos_idle_hook(esp_freertos_idle_cb_t new_idle_cb);
...
/**
  ...
  * @return ESP_ERR_NO_MEM : No more space to register hook
  */
esp_err_t esp_esp_register_freertos_tick_hook(esp_freertos_tick_cb_t tick_cb);
...
/**
  ...
  * @return void
  */
void esp_esp_deregister_freertos_idle_hook(esp_freertos_idle_cb_t old_idle_cb);
...
/**
  ...
  * @return void
  */
void esp_esp_deregister_freertos_tick_hook(esp_freertos_tick_cb_t old_tick_cb);
