 ...
 */
int esp_register_chipv7_phy(const esp_phy_init_data_t* init_data, esp_phy_calibration_data_t *cal_data, esp_phy_calibration_mode_t cal_mode);
 ...
 */
uint32_t esp_phy_get_rf_cal_version();
 ...
 * @return NULL
 */
void esp_phy_set_wifi_mode_only(bool wifi_only);

/**
 * @brief Set BT the highest priority in coexist mode.
 * @return NULL
 */
void esp_coex_bt_high_prio(void);
