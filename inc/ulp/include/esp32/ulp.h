...
/**@{*/
#define ESP_ERR_ULP_BASE                0x1200                  /*!< Offset for ULP-related esp_error codes */
 ...
 * esp_ulp_process_macros_and_load function.
 *
 ...
 * The token generated by this macro is removed by esp_ulp_process_macros_and_load
 ...
 * real instruction; it is a token which is removed by esp_ulp_process_macros_and_load
 * function.
 */
 ...
 */
esp_err_t esp_ulp_process_macros_and_load(uint32_t load_addr, const ulp_insn_t* program, size_t* psize);
 ...
 */
esp_err_t esp_ulp_run(uint32_t entry_point);
