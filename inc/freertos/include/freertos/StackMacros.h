 ...
 * will also cause the last few stack bytes to be checked to esp_ensure the value
...
/*-----------------------------------------------------------*/
	...
	{																									\
		...
		{																								\
			esp_vApplicationStackOverflowHook( ( TaskHandle_t ) pxCurrentTCB[ xPortGetCoreID() ], pxCurrentTCB[ xPortGetCoreID() ]->pcTaskName );	\
		}																								\
	}
