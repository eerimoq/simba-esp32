...
in the beginning. Two esp_xRingbufferReceive calls will be needed to retrieve the data.
 ...
 *
 * @return A RingbufHandle_t handle to the created ringbuffer, or NULL in case of esp_error.
 */
RingbufHandle_t esp_xRingbufferCreate(size_t buf_length, ringbuf_type_t type);
 ...
 * @return void
 */
void esp_vRingbufferDelete(RingbufHandle_t ringbuf);
 ...
 */
size_t esp_xRingbufferGetMaxItemSize(RingbufHandle_t ringbuf);


/**
 * @brief  Insert an item into the ring buffer
 *
 * @param  ringbuf - Ring buffer to esp_insert the item into
 * @param  data - Pointer to data to esp_insert. NULL is allowed if data_size is 0.
 * @param  data_size - Size of data to esp_insert. A value of 0 is allowed.
 ...
 *         than indicated by esp_xRingbufferGetMaxItemSize(ringbuf).
 */
BaseType_t esp_xRingbufferSend(RingbufHandle_t ringbuf, void *data, size_t data_size, TickType_t ticks_to_wait);
 ...
 */
BaseType_t esp_xRingbufferSendFromISR(RingbufHandle_t ringbuf, void *data, size_t data_size, BaseType_t *higher_prio_task_awoken);
 ...
 */
void *esp_xRingbufferReceive(RingbufHandle_t ringbuf, size_t *item_size, TickType_t ticks_to_wait);
 ...
 */
void *esp_xRingbufferReceiveFromISR(RingbufHandle_t ringbuf, size_t *item_size);
 ...
 *         item. NULL on timeout, *item_size is untouched in that case.
 */
void *esp_xRingbufferReceiveUpTo(RingbufHandle_t ringbuf, size_t *item_size, TickType_t ticks_to_wait, size_t wanted_size);
 ...
 *         item. NULL when the ringbuffer is empty, *item_size is untouched in that case.
 */
void *esp_xRingbufferReceiveUpToFromISR(RingbufHandle_t ringbuf, size_t *item_size, size_t wanted_size);
 ...
 * @return void
 */
void esp_vRingbufferReturnItem(RingbufHandle_t ringbuf, void *item);
 ...
 * @return void
 */
void esp_vRingbufferReturnItemFromISR(RingbufHandle_t ringbuf, void *item, BaseType_t *higher_prio_task_awoken);
 ...
 */
BaseType_t esp_xRingbufferAddToQueueSetRead(RingbufHandle_t ringbuf, QueueSetHandle_t xQueueSet);
 ...
 * @return pdTRUE on success, pdFALSE otherwise
 */
BaseType_t esp_xRingbufferAddToQueueSetWrite(RingbufHandle_t ringbuf, QueueSetHandle_t xQueueSet);
 ...
 * @return pdTRUE on success, pdFALSE otherwise
 */
BaseType_t esp_xRingbufferRemoveFromQueueSetRead(RingbufHandle_t ringbuf, QueueSetHandle_t xQueueSet);
 ...
 * @return pdTRUE on success, pdFALSE otherwise
 */
BaseType_t esp_xRingbufferRemoveFromQueueSetWrite(RingbufHandle_t ringbuf, QueueSetHandle_t xQueueSet);
 ...
 * @return void
 */
void esp_xRingbufferPrintInfo(RingbufHandle_t ringbuf);
